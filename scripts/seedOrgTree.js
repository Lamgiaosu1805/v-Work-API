...
const TREE = [
  ...
  {
    code: "TTKD-HCM",
    name: "TTKD Hồ Chí Minh",
    type: "branch",
    parent: "KHOI-CN",
    address: "Hồ Chí Minh"
  },
  // ─── TTKD theo chức năng (không gắn địa lý) — bổ sung theo BRD KPI ───
  { code: "TTKD-PRIORITY", name: "TTKD Priority", type: "branch", parent: "KHOI-CN" },
  { code: "TTKD-ONLINE", name: "TTKD Sale Online 24/7", type: "branch", parent: "KHOI-CN" },
  { code: "TTKD-PARTNER", name: "Trung Tâm Phát Triển Đối Tác", type: "branch", parent: "KHOI-CN" }
];
